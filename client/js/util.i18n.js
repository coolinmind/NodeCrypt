...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'system.duplicate_username_kicked': 'You were removed because this room does not allow duplicate usernames.',
			...
			'system.is_typing': '{user} is typing...',
